...
@AllArgsConstructor
@NoArgsConstructor
public class ActualizarProponenteExperienciaResponse implements Serializable {
    ...
    private Integer registros_insertados;
    private Integer registros_actualizados;
    private Integer registros_eliminados;
