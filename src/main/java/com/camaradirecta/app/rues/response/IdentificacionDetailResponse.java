...
@AllArgsConstructor
@NoArgsConstructor
public class IdentificacionDetailResponse implements Serializable {
	
	private String codigo_clase_identificacion;
    private String desc_clase_identificacion;
    private String numero_identificacion;
    private String digito_verificacion;
    private String razon_social;
    private String sigla;
    private String codigo_camara;
    private String desc_camara;
    private String matricula;
    private String codigo_camara_proponente;
    private String desc_camara_proponente;
    private String inscripcion_proponente;
    private String codigo_tipo_sociedad;
    private String desc_tipo_sociedad;
    private String codigo_organizacion_juridica;
    private String desc_organizacion_juridica;
    private String codigo_categoria_matricula;
    private String desc_categoria_matricula;
    private String codigo_estado_matricula;
    private String desc_estado_matricula;
    private String codigo_estado_proponente;
	...
	public String getIndicador_rnt() {
